...
public class Main {
    ...
    private static void updateStudentUI(Scanner sc, StudentManager manager) {
        ...
        double diemHoa = readDoubleInRange(sc, "Nhap diem hoa (0-10): ", 0, 10);
        // readDoubleInRange
        // Nhập một số kiểu double từ bàn phím
        // Và kiểm tra xem số đó có nằm trong một khoảng (range) hợp lệ hay không
        //Nếu người dùng nhập sai (không phải số, hoặc nằm ngoài khoảng), hàm sẽ yêu cầu nhập lại.
    ...
    //continue:Bỏ qua phần còn lại của vòng lặp hiện tại và quay lại đầu vòng lặp
    //Khi nhập sai: In thông báo lỗi
    //Quay về đầu vòng lặp để yêu cầu nhập lại

    //min, max: giới hạn thấp nhất và cao nhất mà người dùng được phép nhập
    // "Nhap diem toan (0-10): ", 0, 10
